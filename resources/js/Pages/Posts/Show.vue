...
const updateComment = async () => {
    if (! await confirmation('Are you sure?', 'You just updating your comment')) {
...
const deleteComment = async (commentId) => {
   if (! await confirmation('Are you sure?', 'Are you sure you want to delete this comment?')) {
        return;
   }
            ...
            <div class="mt-12">
                ...
                <form v-if="$page.props.auth.user" @submit.prevent="() => commentIdBeingEdited ? updateComment() : addComment()" class="mt-4">
                    <div>
                        ...
                        <TextArea ref="commentTextAreaRef" id="body" rows="4" v-model="commentForm.body" placeholder="Your comment here..." />
